...
function check_new_version(){
    ...
    function check_version_on_git(){
        $.get("https://raw.githubusercontent.com/IVUCB4T/WBPDTool/main/Settings.json",function(data){
            new_version = JSON.parse(data)
                if(last_version < new_version.version){
                    show_notif("New version available :)","https://github.com/IVUCB4T/WBPDTool",true)
                }
        })
    }
...
$(document).ready(function(){
    ...
    setTimeout(function(){
        ...
        $(".cp-btn").click(function(){
            ...
            Swal.fire({
                icon: 'success',
                title: 'The link was copied! Thank you for using WBPDTool',
                text: node
                })
